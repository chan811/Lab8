describe('Party Horn Tests', () => {
  ...
  it('Image & Sound changes when select the party horn radio button', () => {
  ...
  it('Volume image goes from mute bars to 1 when the volume level goes from 0 to 1', () => {
    cy.get('#volume-slider')
      .invoke('val', 0)
      .trigger('input');
    cy.get('#volume-image').then($el => {
  ...
  it('error is shown when you type a number outside of the given range for the volume textbox input', () => {
    cy.get('#volume-number').clear().type('999999999999999999');
